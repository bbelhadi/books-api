  ...
  render: function () {
    ...
    return (
      <div className="cardSum">
        <h2>Cart summary</h2>
        <p><span>Total price: {self.state.totalPrice} €</span></p>
        <p><span className="best">Total after best commercial offer: <span className="lineThrough">{self.state.totalPrice}€</span> to {self.state.totalAfterOffer}€</span></p>
      </div>
    );
  }
});
